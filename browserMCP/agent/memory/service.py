...
from browserMCP.agent.message_manager.service import MessageManager
from browserMCP.agent.message_manager.views import ManagedMessage, MessageMetadata
...
class Memory:
	...
	def _create(self, messages: list, current_step: int) -> str | None:
