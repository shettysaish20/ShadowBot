...
def setup_logging():
	...
	log_type = os.getenv('browserMCP_LOGGING_LEVEL', 'info').lower()
	...
	# Configure browserMCP logger
	browserMCP_logger = logging.getLogger('browserMCP')
	browserMCP_logger.propagate = False  # Don't propagate to root logger
	browserMCP_logger.addHandler(console)
	browserMCP_logger.setLevel(root.level)  # Set same level as root logger
