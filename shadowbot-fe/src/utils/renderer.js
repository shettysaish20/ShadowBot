...
const shadowBotApp = document.querySelector('shadow-bot-app');

// Consolidated cheddar object - all functions in one place
const cheddar = {
    // Element access
    element: () => shadowBotApp,
    e: () => shadowBotApp,

    // App state functions - access properties directly from the app element
    getCurrentView: () => shadowBotApp.currentView,
    getLayoutMode: () => shadowBotApp.layoutMode,

    // Status and response functions
    setStatus: text => shadowBotApp.setStatus(text),
    setResponse: response => shadowBotApp.setResponse(response),
