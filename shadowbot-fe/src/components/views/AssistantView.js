...
import { configure as agentConfigure, runJob as agentRunJob, cancelJob as agentCancelJob, retryLastJob as agentRetryJob, subscribe as agentSubscribe, getSnapshot as agentGetSnapshot, uploadImages } from '../../utils/agentStream.js';
 ...
 * {
 ...
 ${this._hasStoredScreenshot ? 'Ready' : 'SS'}
 </button>
 </div>
